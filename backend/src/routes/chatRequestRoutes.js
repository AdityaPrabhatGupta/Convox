...
router.get("/pending", getPendingRequests);                // GET    /api/chat-requests/pending
...
router.post("/accept", acceptChatRequest);                  // POST   /api/chat-requests/accept
router.post("/reject", rejectChatRequest);                  // POST   /api/chat-requests/reject
